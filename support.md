...
- The Settings button in the library's toolbar switches between automatic, light, and dark appearance, and on iPhone so does the top of the reader's ⋯ menu. Reading settings choose the appearance too, along with serif or sans-serif type, text size, line spacing, and page width. Settings → Code chooses a color scheme for code or turns coloring off.
